...
/**
 * Servlet that processes a request for a user to join a chat room.
 * 
 * @author Colin Kho
 *
 */
@SuppressWarnings("serial")
public class JoinRoomServlet extends BaseServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		ChatCode chatCodeJoinSuccess = ChatManager.chatcodeJoinRoom(userInfo, chatRoomInfo);
